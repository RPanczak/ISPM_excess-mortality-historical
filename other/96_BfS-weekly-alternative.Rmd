...
2021
canton
https://www.bfs.admin.ch/bfs/en/home/statistics/catalogues-databases/tables.assetdetail.17824512.html
gr
https://www.bfs.admin.ch/bfs/en/home/statistics/catalogues-databases/tables.assetdetail.17824512.html
...
```{r eval=FALSE}
download.file(url = "https://www.experimental.bfs.admin.ch/bfsstatic/dam/assets/17824489/master",
              destfile = "data-raw/BfS/MOMO/ts-d-14.03.04.04-wr.csv", 
              method = "curl")
```
...
```{r eval=FALSE}
download.file(url = "https://www.experimental.bfs.admin.ch/bfsstatic/dam/assets/17824507/master",
              destfile = "data-raw/BfS/MOMO/ts-d-14.03.04.05-wr.csv", 
              method = "curl")
```
...
```{r eval=FALSE}
download.file(url = "https://www.experimental.bfs.admin.ch/bfsstatic/dam/assets/17824492/master",
              destfile = "data-raw/BfS/MOMO/ts-d-14.03.04.06-wr.csv", 
              method = "curl")
```
