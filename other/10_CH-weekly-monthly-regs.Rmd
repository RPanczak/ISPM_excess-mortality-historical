...
Comparison of differences in excess deaths during one year depending on use of weekly vs. monthly data.

Implemented with simple frequentest model.
...
```{r}
deaths_week <- read_rds("data/BfS/deaths_week_2010-2021.Rds")  %>% 
