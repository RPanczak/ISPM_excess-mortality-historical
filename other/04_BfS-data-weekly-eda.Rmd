...
```{r include=FALSE}
week_2010_2021 <- bind_rows(
  read_rds("data/BfS/bfs_deaths_week_2010-2019.Rds"), 
  read_rds("data/BfS/bfs_deaths_week_2020-2021.Rds")
) %>% 
