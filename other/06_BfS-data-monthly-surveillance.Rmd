...
Population is available till 2019 only. 2020 figures are borrowed from COVID monitoring website from BAG and described in `00.Rmd`. 
...
Takes very long time; experimental; hinky results so far.
...
compare <- combineSTS(list(#boda = boda, 
                           farrington = farrington, farringtonFlexible = noufaily))
