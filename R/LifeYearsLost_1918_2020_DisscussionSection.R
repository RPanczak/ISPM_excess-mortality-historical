...
password <- readr::read_file("secrets/password.txt")
password
...
Switzerland <- readHMDweb(CNTRY = "CHE", item = "bltper_1x1" , 
                          username = username, password = password,
                          fixup=FALSE)
Switzerland$country <- "CHE"


Spain <- readHMDweb(CNTRY = "ESP", item = "bltper_1x1", 
                    username = username, password = password,
                    fixup=FALSE)

Spain$country  <- "SPAIN"

Sweden <- readHMDweb(CNTRY = "SWE", item ="bltper_1x1", 
                     username = username, password = password,
                     fixup=FALSE)
