...
fn_global_serfling_nb_stan = function(pred_year, monthly_data, ignore_year=NULL, prior=10, prior_intercept=10, p=0.99) {
  require(rstan)
  ...
  # sampling
  ss = stan(file="stan/global_serfling_nb.stan",
            data=dd_list,
            chains=4,
            iter=2000)
  # get prediction
