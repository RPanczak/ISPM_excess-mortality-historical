...
# for (COUNTRY in c("Sweden")) {
  ...
  # for (YEAR in 1919) {
    ...
    write_rds(results_month_pand, paste0(path0,"results_month_pand.Rds"))
    write_rds(results_year_pand, paste0(path0,"results_year_pand.Rds"))
    write_rds(results_age_pand, paste0(path0,"results_age_pand.Rds"))
  }
} 
