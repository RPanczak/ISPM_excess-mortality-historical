...
fn_plot_global_serfling(expected_2020, title="Expected deaths for 2020", ylim=c(0,12000))
```
...
fn_plot_global_serfling(expected_2020_stan, title="Expected deaths for 2020 (stan)", ylim=c(0,12000))
```
...
fn_plot_global_serfling(expected_2020_nb_stan, title="Expected deaths for 2020 (nb, stan)", ylim=c(0,12000))
```
...
fn_plot_global_serfling(expected_2020_age_nb_stan, title="Expected deaths for 2020 (nb, age, stan)", ylim=c(0,12000))
```
