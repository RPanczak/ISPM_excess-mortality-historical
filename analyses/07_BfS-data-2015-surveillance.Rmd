...
```{r echo=FALSE}
par(mar = c(2, 4, 1, 1))
plot(noufaily_weekly_0, main = "", legend.opts = list(x = "topright"))
```
...
```{r echo=FALSE}
plot(farrington_weekly_0, main = "", legend.opts = list(x = "topright"))
```
...
```{r echo=FALSE}
par(mar = c(2, 4, 1, 1))
plot(noufaily_weekly_65, main = "", legend.opts = list(x = "topright"))
```
...
```{r echo=FALSE}
plot(farrington_weekly_65, main = "", legend.opts = list(x = "topright"))
```
...
deaths_weekly_0 %>% 
  ...
  geom_line(aes(y = excess_bfs + excess_calc)) +
  ylim(-20, 10) +
