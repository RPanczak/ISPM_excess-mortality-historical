...
pop_yearly_age_sex <- bind_rows(
  ...
  # !!! temp solution for ES & CH for 2020 !!!
  hmd_pop_age_sex %>% 
...
deaths_yearly_age_sex <- bind_rows(
  ...
  # 2019 is already in HMD for Sweden
  se_deaths_age_sex_2019 %>% 
    filter(Year == 2020),
  
  es_deaths_age_sex_2019,
  
  ch_deaths_age_sex_2019
