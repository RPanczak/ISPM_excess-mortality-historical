...
write_rds(hmd_ch_deaths_year, "data/mortality_org/hmd_ch_deaths_year.Rds")
write_dta(hmd_ch_deaths_year, "data/mortality_org/hmd_ch_deaths_year.dta")
```

Available from `r min(hmd_ch_deaths_year$Year)` to `r max(hmd_ch_deaths_year$Year)`.

```{r echo=FALSE}
ggplot(hmd_ch_deaths_year, aes(x = Year)) +
...
write_rds(hmd_ch_deaths_age_sex, "data/mortality_org/hmd_ch_deaths_age_sex.Rds")
write_dta(hmd_ch_deaths_age_sex, "data/mortality_org/hmd_ch_deaths_age_sex.dta")
```
...
hmd_ch_deaths_age_sex %>% 
  ...
  mutate(age_cat = cut(age, seq(0, 110, 10), include.lowest = TRUE)) %>% 
...
write_rds(hmd_es_deaths_year, "data/mortality_org/hmd_es_deaths_year.Rds")
write_dta(hmd_es_deaths_year, "data/mortality_org/hmd_es_deaths_year.dta")
```

Available yearly from `r min(hmd_es_deaths_year$Year)` to `r max(hmd_es_deaths_year$Year)`.

```{r echo=FALSE}
ggplot(hmd_es_deaths_year, aes(x = Year)) +
  geom_line(aes(y = deaths_year)) +
  theme_bw() +
  xlab("") + ylab("Yearly number of deaths")
```
...
write_rds(hmd_es_deaths_age_sex, "data/mortality_org/hmd_es_deaths_age_sex.Rds")
write_dta(hmd_es_deaths_age_sex, "data/mortality_org/hmd_es_deaths_age_sex.dta")
```
...
write_rds(hmd_se_deaths_year, "data/mortality_org/hmd_se_deaths_year.Rds")
write_dta(hmd_se_deaths_year, "data/mortality_org/hmd_se_deaths_year.dta")
```

Available yearly from `r min(hmd_se_deaths_year$Year)` to `r max(hmd_se_deaths_year$Year)`.

```{r echo=FALSE}
ggplot(hmd_se_deaths_year, aes(x = Year)) +
  geom_line(aes(y = deaths_year)) +
  theme_bw() +
  xlab("") + ylab("Yearly number of deaths")
```
...
write_rds(hmd_se_deaths_age_sex, "data/mortality_org/hmd_se_deaths_age_sex.Rds")
write_dta(hmd_se_deaths_age_sex, "data/mortality_org/hmd_se_deaths_age_sex.dta")
```
