...
library(pacman)
p_load(tidyverse, magrittr, janitor, scales, lemon,
       readxl, haven,anytime,lubridate,
       kableExtra,
       aweek, wktmo)
```
...
es_2020 <- fn_get_death_data_spain() %>%
...
es_pop_2020 <- fn_get_spain_population() %>%
...
es_pop_age_2020 <- fn_get_spain_population() %>%
  mutate(Year = as.integer(2020),
         Age = as.integer(Age),
         Population = as.integer(Population),
         Country = "Spain") %>% 
