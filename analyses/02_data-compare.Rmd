...
Example of age breakdown, showing demographic transition and first, crude indication of the effects of pandemics.  
...
Again, age structure is available on yearly resolution. Example of three countries, starting at minimum year of coverage for all of them.    
...
For comparison against 2020 & 21 we use data from HMD (for SWE & CHE) and INE (for ESP). For the latter we use `Main series since 1971` from [here](https://www.ine.es/jaxiT3/Tabla.htm?t=31304). # HMD docs say that pop Spain 2013-2019 are from: *"1 Jan"* so using data from this time point for consistency.  
