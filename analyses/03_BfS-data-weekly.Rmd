...
write_rds(week_2010_2019, "data/BfS/bfs_deaths_week_2010-2019.Rds")
haven::write_dta(week_2010_2019, "data/BfS/bfs_deaths_week_2010-2019.dta")
```

```{r include=FALSE}
week_2010_2019 <- read_rds("data/BfS/bfs_deaths_week_2010-2019.Rds") 
```
...
write_rds(week_2020_2021, "data/BfS/bfs_deaths_week_2020-2021.Rds")
haven::write_dta(week_2020_2021, "data/BfS/bfs_deaths_week_2020-2021.dta")
```

```{r include=FALSE}
week_2020_2021 <- read_rds("data/BfS/bfs_deaths_week_2020-2021.Rds")
```
...
# Comparing BfS to STMF (week)

Until April, all seems to be fine, except some end of the year correction (?):
