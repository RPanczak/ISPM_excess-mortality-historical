...
deaths_monthly <- read_rds("data/deaths_monthly.Rds") %>% 
  filter(Country == "Spain", Year >= 2016)
...
write_rds(results_month_pand, paste0(path0,"Spain_results_month_pand.Rds"))
write_rds(results_year_pand, paste0(path0,"Spain_results_year_pand.Rds"))
write_rds(results_age_pand, paste0(path0,"Spain_results_age_pand.Rds"))