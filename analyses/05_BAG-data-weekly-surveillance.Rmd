...
```{r}
control1 <- list(range = in2020, noPeriods = 1, b = 4, w = 3,
                 weightsThreshold = 1, pastWeeksNotIncluded = 3,
                 pThresholdTrend = 0.05, thresholdMethod = "delta")
...
```{r}
control2 <- list(range = in2020, noPeriods = 10, b = 4, w = 3,
                 weightsThreshold = 2.58, pastWeeksNotIncluded = 26,
