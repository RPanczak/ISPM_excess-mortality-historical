...
results_month <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_month.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_month.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_month.Rds")
)) %>% 
...
results_year <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_year.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_year.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_year.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
...
results_age <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_age.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_age.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_age.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  arrange(Country, Year) %>% 
...
# #########################################################################
# sensitivity for using frequentist model, unadjusted for age
results_month_boot <- read_rds("data/outputs_2021-11-17/All_results_month.Rds") %>% 
  mutate(Date = anytime::anydate(paste0(Year, "-", Month))) %>% 
  arrange(Country, Year, Month) %>% 
  mutate(across(pred:excess_month_lower, round)) %>% 
...
# #########################################################################
# sensitivity for alternative time window & min/max selection
results_month_last_7 <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_month_last_7_trim.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_month_last_7_trim.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_month_last_7_trim.Rds")
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  mutate(Date = anytime::anydate(paste0(Year, "-", Month))) %>% 
  arrange(Country, Year, Month) %>% 
...
results_year_last_7 <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_year_last_7_trim.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_year_last_7_trim.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_year_last_7_trim.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  arrange(Country, Year) %>% 
  mutate(across(excess_year:excess_year_upper, round)) %>% 
...
results_age_last_7 <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_age_last_7_trim.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_age_last_7_trim.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_age_last_7_trim.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  arrange(Country, Year) %>% 
  mutate(across(pred:excess_year_upper, round)) %>% 
...
# #########################################################################
# sensitivity for including effects of pandemics
results_month_pand <- merge_mort(bind_rows(
  read_rds("data/outputs_2021-11-17/All_results_month_pand.Rds"),
  # read_rds("data/outputs_2021-11-17/Sweden_results_month_pand.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_month_pand.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_month_pand.Rds")
)) %>% 
...
results_year_pand <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_year_pand.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_year_pand.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_year_pand.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB, pandemic)") %>%
  arrange(Country, Year) %>% 
  mutate(across(excess_year:excess_year_upper, round)) %>% 
...
results_age_pand <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_age_pand.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_age_pand.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_age_pand.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB, pandemic)") %>%
  arrange(Country, Year) %>% 
  mutate(across(pred:excess_year_upper, round)) %>% 
...
# #########################################################################
# sensitivity for using expected pops in 2021
results_month_exp <- merge_mort(bind_rows(
  read_rds("data/outputs_2021-11-17/All_results_month_exp.Rds"),
  # read_rds("data/outputs_2021-11-17/Sweden_results_month_exp.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_month_exp.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_month_exp.Rds")
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  mutate(Date = anytime::anydate(paste0(Year, "-", Month))) %>% 
  arrange(Country, Year, Month) %>% 
...
results_year_exp <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_year_exp.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_year_exp.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_year_exp.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  arrange(Country, Year) %>% 
  mutate(across(excess_year:excess_year_upper, round)) %>% 
...
results_age_exp <- merge_mort(bind_rows(
  # read_rds("data/outputs_2021-11-17/Sweden_results_age_exp.Rds"), 
  # read_rds("data/outputs_2021-11-17/Spain_results_age_exp.Rds"),
  read_rds("data/outputs_2021-11-17/Switzerland_results_age_exp.Rds") 
)) %>% 
  filter(Model == "Age Serfling (Stan, NB)") %>% 
  arrange(Country, Year) %>% 
  mutate(across(pred:excess_year_upper, round)) %>% 
...
```{r echo=FALSE}
bind_rows(
  read_rds("data/outputs_2021-11-17/All_results_month.Rds"), 
  read_rds("data/outputs_2021-11-17/Switzerland_results_month.Rds"), 
  read_rds("data/outputs_2021-11-17/Sweden_results_month.Rds"), 
  read_rds("data/outputs_2021-11-17/Spain_results_month.Rds")
) %>%  
