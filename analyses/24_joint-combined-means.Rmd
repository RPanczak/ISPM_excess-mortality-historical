...
results_month <- merge_mort(bind_rows(
  ...
  read_rds("data/outputs_2021-11-23/Spain_results_month.Rds"),
...
results_year <- merge_mort(bind_rows(
  ...
  read_rds("data/outputs_2021-11-23/Spain_results_year.Rds"),
...
results_age <- merge_mort(bind_rows(
  ...
  read_rds("data/outputs_2021-11-23/Spain_results_age.Rds"),
...
#   read_rds("data/outputs_2021-11-23/Spain_results_month_last_7_trim.Rds"),
...
results_year_last_7 <- merge_mort(bind_rows(
  ...
  # read_rds("data/outputs_2021-11-23/Spain_results_year_last_7_trim.Rds"),
...
#   read_rds("data/outputs_2021-11-23/Spain_results_age_last_7_trim.Rds"),
...
results_month_pand <- merge_mort(bind_rows(
  ...
  read_rds("data/outputs_2021-11-23/Spain_results_month_pand.Rds"),
...
#   read_rds("data/outputs_2021-11-23/Spain_results_year_pand.Rds"),
...
#   read_rds("data/outputs_2021-11-23/Sweden_results_age_pand.Rds"),
#   read_rds("data/outputs_2021-11-23/Spain_results_age_pand.Rds"),
#   read_rds("data/outputs_2021-11-23/Switzerland_results_age_pand.Rds") 
# )) %>% 
#   filter(Model == "Age Serfling (Stan, NB, pandemic)") %>%
#   arrange(Country, Year) %>% 
#   mutate(across(pred:excess_year_upper, round)) %>% 
...
#   read_rds("data/outputs_2021-11-23/All_results_month_exp.Rds"),
#   read_rds("data/outputs_2021-11-23/Sweden_results_month_exp.Rds"),
#   read_rds("data/outputs_2021-11-23/Spain_results_month_exp.Rds"),
#   read_rds("data/outputs_2021-11-23/Switzerland_results_month_exp.Rds")
# )) %>% 
#   filter(Model == "Age Serfling (Stan, NB)") %>% 
#   mutate(Date = anytime::anydate(paste0(Year, "-", Month))) %>% 
#   relocate(c(n_eff, Rhat), .after = last_col()) %>% 
...
results_year_exp <- merge_mort(bind_rows(
  ...
  read_rds("data/outputs_2021-11-23/Spain_results_year_exp.Rds"),
...
#   read_rds("data/outputs_2021-11-23/Sweden_results_age_exp.Rds"),
#   read_rds("data/outputs_2021-11-23/Spain_results_age_exp.Rds"),
#   read_rds("data/outputs_2021-11-23/Switzerland_results_age_exp.Rds") 
# )) %>% 
#   filter(Model == "Age Serfling (Stan, NB)") %>% 
#   arrange(Country, Year) %>% 
#   mutate(across(pred:excess_year_upper, round)) %>% 
...
table_1 <- 
  ...
  left_join(
    ...
    results_year %>% 
      filter(Year %in% pandemic_year) %>% 
      mutate(Expected = paste0(number(plyr::round_any(yearly_pred_total_deaths_lower, 100),
                                      big.mark = ","), 
                       "-",
                number(plyr::round_any(yearly_pred_total_deaths_upper, 100),
                                      big.mark = ","))) %>% 
...
table_1 %>% 
  ...
  footnote(alphabet=c("Model-predicted number of all-cause deaths from the five preceding years (95% credible interval, rounded to the next 100).",
                      "Data from ..."))
```
...
```{r echo=FALSE}
bind_rows(
  read_rds("data/outputs_2021-11-23/All_results_month.Rds"), 
  read_rds("data/outputs_2021-11-23/Switzerland_results_month.Rds"), 
  read_rds("data/outputs_2021-11-23/Sweden_results_month.Rds"), 
  read_rds("data/outputs_2021-11-23/Spain_results_month.Rds")
) %>%  
