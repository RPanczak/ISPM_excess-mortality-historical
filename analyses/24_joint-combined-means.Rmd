...
table_s1 <- 
  ...
  bind_rows(
    ...
    # global serfling stan without age, different time window
    results_year_last_7  %>% 
      mutate(Model = "m3")
  ...
  mutate(
    excess_year_m1 = number(excess_year_m1, big.mark = ","),
    excess_year_m2 = number(excess_year_m2, big.mark = ","),
    excess_year_m3 = number(excess_year_m3, big.mark = ",")
  ) %>% 
  ...
  mutate(
    excess_year_m3_cri = str_c("(", 
                               number(excess_year_lower_m3, big.mark = ","), 
                               "; ",
                               number(excess_year_upper_m3, big.mark = ","), 
                               ")")
  ) %>% 
...
Comparing using observed versus expected population counts.  
