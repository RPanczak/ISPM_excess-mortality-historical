...
haven::write_dta(ch_expected_deaths_monthly, "data/ch_expected_deaths_monthly.dta")
```
...
anim_save("res/ch_mort_anim.gif")

p_unload(gganimate)
```

![](../res/ch_mort_anim.gif)

## Stacked

```{r echo=FALSE}
ch_expected_deaths_monthly %>% 
  mutate(Year = as.integer(Year),
         Month = as.integer(Month)) %>% 
  ggplot(aes(x = Month)) +
