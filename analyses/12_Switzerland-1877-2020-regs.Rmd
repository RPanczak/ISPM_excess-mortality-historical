...
subtitle: "1877-2020 monthly BfS data & regression approach"
...
Data untill 2019 from BfS online sources; 2020 from STMF.  
...
dcmp <- deaths_monthly %>%
  ...
  fabletools::model(feasts::STL((Deaths/Population)*100000 ~ season(window = Inf)))
