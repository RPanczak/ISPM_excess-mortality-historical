...
for (YEAR in (YEARS$MIN+5):2020) {
  ...
  ### Save
  rm(extract_month, extract_year, extract_age)
  write_rds(results_month, paste0(path0,"Sweden_results_month_exp.Rds"))
  write_rds(results_year, paste0(path0,"Sweden_results_year_exp.Rds"))
  write_rds(results_age, paste0(path0,"Sweden_results_age_exp.Rds"))
}
...
for (YEAR in (YEARS$MIN+5):2020) {
  ...
  ### Save
  rm(extract_month, extract_year, extract_age)
  write_rds(results_month, paste0(path0,"Sweden_results_month_pand.Rds"))
  write_rds(results_year, paste0(path0,"Sweden_results_year_pand.Rds"))
  write_rds(results_age, paste0(path0,"Sweden_results_age_pand.Rds"))
}
...
for (YEAR in (YEARS$MIN+5):2020) {
  ...
  ### Save
  rm(extract_month, extract_year, extract_age)
  write_rds(results_month, paste0(path0,"Sweden_results_month_sst1.Rds"))
  write_rds(results_year, paste0(path0,"Sweden_results_year_sst1.Rds"))
  write_rds(results_age, paste0(path0,"Sweden_results_age_sst1.Rds"))
}
