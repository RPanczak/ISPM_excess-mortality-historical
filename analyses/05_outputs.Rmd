...
```{r include=FALSE}
ggsave(plot = gg, "paper/Figure_2_alt.png", 
       dpi = 300, width =  190, height = 140, units = "mm")
```
...
```{r include=FALSE}
ggsave(plot = gg, "paper/Figure_3_alt.png", 
       dpi = 300, width =  190, height = 140, units = "mm")
```
...
results_month %>% 
  ...
  facet_wrap(facets = vars(Country), 
             ...
             scales = "free_y",
             strip.position = "top") + 
  ylab("Monthly Excess Deaths per 100 000 Persons, n") + 
  theme_bw() +
  theme(
    strip.background = element_blank(),
    strip.text.x = element_text(margin = margin(0, 0, 0, 0)),
